...
`@nestjs/helix` is a package that provides adapters to use [helix](https://github.com/contra/graphql-helix) and [envelop](https://github.com/dotansimha/envelop) in combination with `@nestjs/graphql`.

## Installation

> **NOTE** `helix` is compatible with both Express and Fastify.
